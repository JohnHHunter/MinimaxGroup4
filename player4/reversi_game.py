...
from reversi_players import HumanPlayer, RandomComputerPlayer, GreedyComputerPlayer, MinimaxPlayer, MinimaxComputerPlayer
...
def compare_players(player1, player2, board_size=5, board_filename=None):
...
def main():
    ...
    compare_players(MinimaxComputerPlayer("X"), MinimaxPlayer("O"))
